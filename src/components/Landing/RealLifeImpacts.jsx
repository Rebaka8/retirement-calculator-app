    ...
    return (
        <section id="real-life-impacts" className="py-12 bg-white scroll-mt-28">
            <div className="max-w-7xl mx-auto px-6">
                <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 md:p-10 text-center mx-2 md:mx-0">
                    <Heart className="w-12 h-12 text-rose-500 mx-auto mb-4" />
                    <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-8">Real-Life Impact: Why You Should Care</h3>
