...
import { Download, RefreshCw, TrendingUp, Zap, AlertTriangle, CheckCircle, Target, Wallet, FileText, Share2, X, Link, Mail, MessageCircle, ChevronLeft } from 'lucide-react';
                    ...
                    <div className={`lg:col-span-7 flex flex-col h-full space-y-5 ${!showResults ? 'hidden lg:flex' : 'flex'}`}>
                        ...
                        <div className="lg:hidden mb-4">
                            <button
                                ...
                                className="w-auto inline-flex items-center justify-center gap-2 py-2 px-4 bg-white border border-indigo-200 rounded-full shadow-sm text-indigo-700 font-bold text-xs hover:bg-indigo-50 transition-all active:scale-95 group"
                            >
